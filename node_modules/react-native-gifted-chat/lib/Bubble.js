...
export default class Bubble extends React.Component {
    ...
    renderQuickReplies() {
        ...
        if (currentMessage && currentMessage.quickReplies) {
            const _a = this.props, { containerStyle, wrapperStyle } = _a, quickReplyProps = tslib_1.__rest(_a, ["containerStyle", "wrapperStyle"]);
    ...
    renderMessageText() {
        if (this.props.currentMessage && this.props.currentMessage.text) {
            const _a = this.props, { containerStyle, wrapperStyle } = _a, messageTextProps = tslib_1.__rest(_a, ["containerStyle", "wrapperStyle"]);
    ...
    renderMessageImage() {
        if (this.props.currentMessage && this.props.currentMessage.image) {
            const _a = this.props, { containerStyle, wrapperStyle } = _a, messageImageProps = tslib_1.__rest(_a, ["containerStyle", "wrapperStyle"]);
    ...
    renderMessageVideo() {
        if (this.props.currentMessage && this.props.currentMessage.video) {
            const _a = this.props, { containerStyle, wrapperStyle } = _a, messageVideoProps = tslib_1.__rest(_a, ["containerStyle", "wrapperStyle"]);
    ...
    renderTime() {
        if (this.props.currentMessage && this.props.currentMessage.createdAt) {
            const _a = this.props, { containerStyle, wrapperStyle, textStyle } = _a, timeProps = tslib_1.__rest(_a, ["containerStyle", "wrapperStyle", "textStyle"]);
