...
b.storedProgress);c.appendChild(this.progressBar_);this.card_.appendChild(c);a.appendChild(this.card_);this.remakeButtons()};AssetCard.prototype.addFeatureIcon_=function(a,b){var c=document.createElement("div");c.classList.add("feature-icon");c.setAttribute("icon",a);this.featureIconsContainer_.appendChild(c);ShakaDemoTooltips.make(this.featureIconsContainer_,c,b)};
...
AssetCard.prototype.makeUnsupportedButton_=function(a,b){var c=this.addButton(a,function(){});c.setAttribute("disabled","");var d=this.card_.parentElement;if(d&&b){var e=document.createElement("div");c.parentElement&&c.parentElement.removeChild(c);e.classList.add("tooltip-attach-point");e.appendChild(c);this.actions_.appendChild(e);ShakaDemoTooltips.make(d,e,b)}return c};AssetCard.prototype.selectByAsset=function(a){this.card_.classList.remove("selected");this.asset_==a&&this.card_.classList.add("selected")};
AssetCard.prototype.remakeButtons=function(){shaka.ui.Utils.removeAllChildren(this.actions_);this.remakeButtonsFn_(this)};
AssetCard.prototype.addStoreButton=function(){var a=this,b=function(a,b){a.classList.add("asset-card-corner-button");var c=document.createElement("i");c.textContent=b;c.classList.add("material-icons");a.appendChild(c)},c=shakaDemoMain.getAssetUnsupportedReason(this.asset_,!0);if(c||!this.asset_.storeCallback)c=this.makeUnsupportedButton_("",c),b(c,"get_app");else if(this.asset_.isStored()){var d=this.addButton("",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function g(){return $jscomp.generator.createGenerator(g,
function(b){switch(b.nextAddress){case 1:return d.disabled=!0,b.yield(a.asset_.unstoreCallback(),2);case 2:a.remakeButtons(),b.jumpToEnd()}})})});b(d,"delete")}else{var e=this.addButton("",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function g(){return $jscomp.generator.createGenerator(g,function(b){switch(b.nextAddress){case 1:return e.disabled=!0,b.yield(a.asset_.storeCallback(),2);case 2:a.remakeButtons(),b.jumpToEnd()}})})});b(e,"get_app")}};
